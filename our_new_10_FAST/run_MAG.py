...
from util.data import load_MAG_data
...
def main(args):
    ...
    features, type_mask, labels, train_idx, val_idx, test_idx, homo_graph, homo_dhg_graph, semantic_graph, hp_G \
        = load_MAG_data(device=args['device'])
    labels_plt = labels
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='MAG', choices=['DBLP', 'DBLP_S', 'ACM_NEW', 'ACM', 'IMDB', 'ACM_L', 'MAG'])
